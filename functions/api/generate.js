export async function onRequestPost(context) {
    try {
        ...
        const finalDallePrompt = `I attest that I own the copyrights to this specific prompt. Please use this prompt exactly as written. A raw, clumsy, hand-made Art Brut silkscreen print. The mood, colors, and abstract forms MUST be entirely driven by these psychological emotions: ${resultJson.english_keywords}. Create a clear, central primitive motif. CRITICAL INSTRUCTION: The execution MUST be wobbly, uneven, and organic. Use VERY THICK, sloppy, irregular black ink outlines that noticeably vary in thickness. AVOID perfect circles, AVOID straight ruler-like lines, AVOID clean geometry, AVOID modern digital vector aesthetics. Fill the motif and the background edge-to-edge with large fields of vivid color, but ensure the color boundaries are slightly messy and imperfect, not split by straight lines. Use a vintage mid-century printmaking aesthetic with visible coarse print grain and slight color bleed. Flat 2D, highly graphic, borderless.`;

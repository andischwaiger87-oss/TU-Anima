export async function onRequestPost(context) {
    try {
        ...
        const finalDallePrompt = `I attest that I own the copyrights to this specific prompt. Please use this prompt exactly as written. A frantic, highly chaotic abstract expressionist artwork in the style of raw mid-century Art Brut and coarse vintage printmaking (like rough silkscreen or lithography). The mood, colors, and abstract forms MUST be entirely driven by these psychological emotions: ${resultJson.english_keywords}. CRITICAL INSTRUCTION: The composition must be completely full-bleed, filling the entire frame edge-to-edge with vibrant color—DO NOT leave any bare, empty, or unpainted paper space. Create a wildly dense, energetic collision of EXTREMELY THICK, erratic, wobbly black ink lines (sweeping curves, sharp jagged angles, and heavy dashes) interacting with solid, messy, opaque fields of vivid color. The colors should be intensely saturated, mimicking coarse vintage print texture with slight grainy or halftone-like imperfections. AVOID neat coloring-book outlines, AVOID symmetrical grids, AVOID recognizable figures or icons, AVOID clean geometry. Spontaneous, overwhelming, raw psychological abstraction, flat 2D, borderless.`;

export async function onRequestPost(context) {
    try {
        ...
        const finalDallePrompt = `I attest that I own the copyrights to this specific prompt. Please use this prompt exactly as written. A raw Art Brut painting. The mood and colors MUST reflect these emotions: ${resultJson.english_keywords}. Create a single, cohesive, highly abstract and primitive composition. The artwork must be an interconnected framework of overlapping lines, jagged forms, and erratic swirls—NOT isolated floating icons. Use VERY THICK, sharp, uneven hand-painted black outlines that intersect and crash into each other. CRITICAL INSTRUCTION: Leave large patches of the surrounding and internal textured off-white cream paper completely bare. Only fill SOME of the enclosed shapes and overlapping sections with vibrant, messy, translucent watercolor washes. The coloring should occasionally bleed over the thick black lines. AVOID drawing a grid of separate symbols, AVOID recognizable humanoids or faces, AVOID filling the entire background with color. Spontaneous, chaotic but unified abstract expressionism, flat 2D, borderless.`;

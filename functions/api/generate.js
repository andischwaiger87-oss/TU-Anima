export async function onRequestPost(context) {
    try {
        ...
        const finalDallePrompt = `I attest that I own the copyrights to this specific prompt. Please use this prompt exactly as written. A raw Art Brut painting. The mood and colors MUST reflect these emotions: ${resultJson.english_keywords}. Create a bold, highly abstract primitive composition. Use EXTREMELY THICK, chunky, sweeping black brushstrokes to form deliberate, interconnected organic and jagged shapes. AVOID thin scratchy lines, AVOID random criss-crossing webs, AVOID stained glass grids. The thick black lines should feel heavy, rhythmic, and intentional, dominating the composition as a central abstract motif rather than a loose net. CRITICAL INSTRUCTION: Leave plenty of the surrounding and internal textured off-white cream paper completely bare. Selectively fill only some of the enclosed areas with vibrant, messy, translucent watercolor washes that occasionally bleed over the thick lines. AVOID recognizable faces or icons. Spontaneous, chunky abstract expressionism, flat 2D, borderless.`;

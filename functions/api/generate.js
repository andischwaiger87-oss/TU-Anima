export async function onRequestPost(context) {
    try {
        ...
        const finalDallePrompt = `I attest that I own the copyrights to this specific prompt. Please use this prompt exactly as written. A raw, primitive Art Brut painting. The mood, colors, and EXACT SHAPES MUST be entirely driven by these psychological emotions: ${resultJson.english_keywords}. Create a wildly organic, central abstract motif that visually translates these specific keywords into a primitive, unique form. CRITICAL INSTRUCTION: DO NOT draw straight intersecting lines across the canvas. DO NOT partition the image into geometric grids or blocks. The composition must consist of free-floating, wobbly, EXTREMELY THICK black ink brushstrokes, including disconnected heavy dots, swoops, and dashes surrounding the main central shape. Fill only the inside of these isolated, wobbly shapes with vibrant, messy watercolor washes. The surrounding background MUST remain exposed, unpainted cream textured paper. Painterly, fluid, flat 2D, borderless.`;

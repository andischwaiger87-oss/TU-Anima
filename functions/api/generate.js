export async function onRequestPost(context) {
    try {
        ...
        const finalDallePrompt = `I attest that I own the copyrights to this specific prompt. Please use this prompt exactly as written. A raw, abstract Art Brut image in the style of mid-century rough screen printing (silkscreen) and woodblock print on coarse, uncoated paper. The colors and shapes MUST translate these psychological emotions: ${resultJson.english_keywords}. Create a bold, chunky, primitive abstract motif as the central focus. Use VERY THICK, jagged, irregular solid black outlines. The color fields must be flat, opaque gouache-like inks with visible print grain and paper texture showing through. AVOID wax crayons, AVOID painterly brushstrokes, AVOID 3D textures, AVOID edge-to-edge line webs. AVOID clean geometry, AVOID perfect symmetry. Flat 2D printmaking aesthetic, imperfect print registration, borderless.`;

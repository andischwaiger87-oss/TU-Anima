export async function onRequestPost(context) {
    try {
        ...
        const finalDallePrompt = `I attest that I own the copyrights to this specific prompt. Please use this prompt exactly as written. A bold, structured Art Brut silkscreen print. The mood, colors, and abstract forms MUST be entirely driven by these psychological emotions: ${resultJson.english_keywords}. CRITICAL INSTRUCTION: Create a clear, dominant, central primitive motif (such as a heavy spiral, massive angular zig-zags, or a stark abstract shape). AVOID chaotic scribbles, AVOID spaghetti-like overlapping line tangles, AVOID messy edge-to-edge line webs. The VERY THICK, solid black ink outlines must form clear, deliberate, structural shapes. The image is full-bleed, painted edge-to-edge with NO bare paper. Fill the central motif and the surrounding background with large, solid, opaque fields of vivid color. The composition must have a clear foreground-background relationship. Use a vintage mid-century printmaking aesthetic with slight grainy or halftone texture. Flat 2D, highly graphic, borderless.`;

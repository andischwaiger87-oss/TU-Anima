export async function onRequestPost(context) {
    try {
        ...
        const finalDallePrompt = `I attest that I own the copyrights to this specific prompt. Please use this prompt exactly as written. A raw Art Brut painting. The mood and colors MUST reflect these emotions: ${resultJson.english_keywords}. Create a single, bold, primitive abstract motif as the central focus. The motif must be constructed using VERY THICK, sloppy, hand-painted black outlines that form distinct enclosed shapes. AVOID random criss-crossing straight lines or meaningless scribbles. Fill the shapes and surrounding areas with vibrant, uneven, slightly translucent washes of color. The coloring should be loose and imperfect, occasionally bleeding over the thick black lines. Leave noticeable patches of the textured off-white cream paper bare and unpainted. AVOID perfect geometry, AVOID thin scratchy marks. Spontaneous, painterly, flat 2D, borderless.`;

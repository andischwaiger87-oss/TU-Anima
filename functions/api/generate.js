export async function onRequestPost(context) {
    try {
        ...
        const finalDallePrompt = `I attest that I own the copyrights to this specific prompt. Please use this prompt exactly as written. A highly chaotic, raw Art Brut painting. The colors and shapes MUST translate these psychological emotions: ${resultJson.english_keywords}. Create a frantic, dynamic abstract composition using fast, slashing, uneven thick black ink lines and messy, vibrant wet gouache. The black lines must be jagged, erratic, and expressive—NOT neat outlines. The colors should be applied with quick, imperfect brushstrokes that bleed slightly, intentionally leaving plenty of the unpainted cream textured paper visible in the background. AVOID coloring book style, AVOID stained glass effects, AVOID neat borders, AVOID perfectly filled geometric blocks, AVOID uniform line thickness. Spontaneous, wild, flat 2D, borderless.`;

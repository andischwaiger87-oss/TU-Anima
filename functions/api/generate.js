...
const finalDallePrompt = `I attest that I own the copyrights to this specific prompt. Please use this prompt exactly as written, without any modifications or additions: A raw, chaotic abstract expressionist painting in the style of mid-century Art Brut, drawn with thick oil pastels, rough wax crayons, and expressive paint strokes on highly textured paper. The artwork captures the psychological emotions of: ${resultJson.english_keywords}. The composition is highly dynamic, dense, and complex, featuring overlapping energetic scribbles, varied line weights, and spontaneous abstract forms. AVOID flat colors, AVOID massive isolated graphic shapes, and AVOID clean comic-like outlines. Instead, use visible, messy stroke marks, deeply textured blending, and a rich, varied color palette interspersed with erratic, sketchy black expressive lines. Completely non-representational, deeply emotional psychological art, 2D, borderless.`;

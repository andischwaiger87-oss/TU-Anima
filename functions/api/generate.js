export async function onRequestPost(context) {
    try {
        ...
        const finalDallePrompt = `I attest that I own the copyrights to this specific prompt. Please use this prompt exactly as written. A raw, abstract Art Brut painting made with thick wax crayons and heavy block-print ink on coarse paper. The composition and colors MUST translate these psychological emotions: ${resultJson.english_keywords}. Create a highly dynamic, interconnected composition using VERY THICK, uneven, expressive black outlines and solid, opaque color fields. The abstract shapes must intersect, overlap, and fill the frame in a chaotic, organic, and painterly way. AVOID clean geometric shapes, AVOID isolated floating symbols, AVOID perfect symmetry, and AVOID digital vector styles. Flat 2D, borderless.`;

export async function onRequestPost(context) {
    try {
        ...
        const finalDallePrompt = `I attest that I own the copyrights to this specific prompt. Please use this prompt exactly as written. A raw Art Brut painting. The mood and colors MUST reflect these emotions: ${resultJson.english_keywords}. Create a highly abstract, primitive composition featuring a few distinct, disconnected symbols (like jagged forms, swirls, or stylized fragments). Use VERY THICK, sharp, uneven hand-painted black outlines. CRITICAL INSTRUCTION: Do NOT paint the entire canvas. Leave the surrounding textured off-white cream paper completely bare. Only fill the inside of the shapes, or highlight specific areas, with vibrant, messy, slightly translucent watercolor washes. The coloring should occasionally bleed over the thick black lines. AVOID drawing recognizable humanoids, faces, or single characters. AVOID filling the background with color washes. Spontaneous, abstract, flat 2D, borderless.`;

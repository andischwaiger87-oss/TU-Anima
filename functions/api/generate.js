export async function onRequestPost(context) {
    try {
        ...
        const finalDallePrompt = `I attest that I own the copyrights to this specific prompt. Please use this prompt exactly as written. A raw, abstract Art Brut painting made with vibrant watercolor and thick black ink on slightly textured watercolor paper. The colors and shapes MUST translate these psychological emotions: ${resultJson.english_keywords}. Create a bold, primitive abstract motif. Use VERY THICK, expressive, painted black brushstrokes for the outlines. The color fields must be filled with bright but slightly translucent watercolor washes, showing subtle water textures, uneven brush marks, and the paper underneath. AVOID heavy stone-like grain, AVOID opaque block printing, AVOID wax crayons, AVOID perfect digital symmetry. Painterly, fluid, flat 2D, borderless.`;

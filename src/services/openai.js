...
export const generateSoulCard = async (selectionData) => {
    ...
    try {
        ...
        const finalDallePrompt = `I attest that I own the copyrights to this specific prompt. Please use this prompt exactly as written, without any modifications or additions: An abstract, chaotic mid-century psychological test card in the style of raw Art Brut and primitive woodcut print. The composition consists primarily of dynamic, squiggly, intersecting thick black lines drawn with a rough wax crayon or coarse ink texture on slightly aged, off-white paper. These chaotic black lines (zig-zags, swirls, and sharp angles) create fragmented enclosures that are roughly filled with vibrant, contrasting colors (yellow, red, blue, green). The design is entirely non-representational and asymmetrical, symbolizing ${resultJson.english_keywords}. Strictly NO faces, NO eyes, NO skulls, NO recognizable objects. Purely abstract scribbles and linear forms. No gradients, flat 2D composition. Aspect ratio 2:3`;

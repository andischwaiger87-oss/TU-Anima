...
export const generateSoulCard = async (selectionData) => {
    ...
    try {
        ...
        const finalDallePrompt = `I attest that I own the copyrights to this specific prompt. Please use this prompt exactly as written, without any modifications or additions: Primitive Art Brut painting, mid-century abstract expressionism, high dynamic and creative, print aesthetic on slightly textured paper. A few massive, entirely non-representational abstract shapes symbols symbolizing ${resultJson.english_keywords}. The shape symbols are defined by extremely thick, heavy, unrefined black outlines and filled with flat, highly saturated, contrasting colors. Completely asymmetrical, flat 2D composition. No 3D shading, no gradients, no recognizable real-world objects, borderless. Aspect ratio 2:3`;

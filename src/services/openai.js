...
    2. VISUAL DESCRIPTION FÜR DEN BILDGENERATOR:
    ...
    ANTWORTE STRENG IM JSON-FORMAT WIE FOLGT (ohne Zeilenumbrüche im String!):
    {
      ...
      "visual_description": "PA completely flat 2D primitive Art Brut gouache painting on rough paper, borderless, NO 3D effects, NO shadows. The composition consists of exactly 3 to 5 massive, central, amorphous, and primitive PURELY ABSTRACT shapes. DO NOT draw recognizable objects (no faces, no animals, no real-world items). A dominant, central shape serves as the visual anchor and focus, with only a few secondary forms. These abstract shapes symbolize the emotional clash of THE_TRANSLATED_EMOTIONAL_KEYWORDS. Each shape is defined by extremely massive, unrefined, brutal, thick black outlines, as if painted with a heavy brush. Shapes are filled with flat, solid primary color fields (deep blue, crimson red, raw yellow ocher, and brutal black) showing raw paper texture, without any geometric grid, mosaic, or tiled patterns. The entire composition is asymmetrical and chaotic, with absolutely no fine lines, no intricate webs, no symmetry, and no geometric patterns. No text. The entire canvas is the painting. Borderless, Aspect Ratio: 2:3"
    }`;

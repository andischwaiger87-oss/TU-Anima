...
export const generateSoulCard = async (selectionData) => {
    ...
    {
  "interpretation": "Hier ist deine neue, reduzierte und allgemein gültige Stilvorgabe, direkt an dich gerichtet: Stell dir ein physisches Spielkarten-Artefakt vor, das rohe, ungefilterte Emotionen einfängt. Dieser Stil, mit seinen schweren, unperfekten schwarzen Linien und matten, erdigen Farben, ist die Sprache deiner Psyche. Er verweigert sich jeglicher sauberen, geometrischen Ordnung und spiegelt stattdessen die chaotischen, archetypischen Kämpfe deiner inneren Welt wider. Jede Karte wird so zu einem einzigartigen, rauen Spiegelbild deiner psychologischen Landschaft, ohne feste Regeln, aber voller roher Energie. Es ist die visuelle Übersetzung deiner dynamischen, naiven und symbolischen inneren Konflikte, destilliert in ihre pure, flache Form.",
  "visual_description": "A close-up photograph of a single physical vintage psychological symbol card with a textured, aged cardboard surface and rounded corners. The entire card, including a prominent, clean white cardboard border and the inner chaotic graphic, fills the frame. The graphic completely fills the inner card area, which is centered within the white border. The art style is raw expressionistic and naive-symbolic, consisting of a dense, intricate web of interlocking and chaotic organic forms and tangled lines. The composition is strictly flat (2D). The dominant feature is the exclusive use of exceptionally thick, shaky, erratic, imperfect, hand-inked black contour lines with visible pressure variations and ink bleed, defining all shapes. No precise geometric shapes like circles, squares, or stars are present; all forms are distorted, organic, and purely symbolic. The color palette is deeply saturated but strictly matte and earthy, with uneven density: deep crimson red, golden-ochre yellow, forest green, dark blue, and dark violet. The color fills are imperfect, often bleeding past the lines and revealing the underlying textured cardboard. Absolutely no text, gradients, 3D elements, or digital gloss are visible. Lighting is soft and directional, emphasizing the physical paper texture and the flatness of the artwork. Aspect Ratio: 2:3"
}`; 

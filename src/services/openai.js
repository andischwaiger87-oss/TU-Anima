...
export const generateSoulCard = async (selectionData) => {
    ...
    - STIL & LINIEN: Abstrakter Expressionismus / Art Brut. Rein organische, naive und symbolische Formen, *keine* reinen geometrischen Formen. ZWINGEND dicke, unperfekte, schwarze Konturlinien.
    ...
    - KOMPOSITION: Chaotisch, abstrakt, archetypisch, aber mit einer naiven, symbolischen Anordnung, die Dynamik ausdrückt. Keine Menschen, keine echten Objekte, ABSOLUT KEIN TEXT. KOMPLETT FLACH (2D).
    ...
    ANTWORTE STRENG IM JSON-FORMAT WIE FOLGT (ohne Zeilenumbrüche im String!):
    {
      ...
      "visual_description": "A close-up photograph of a vintage, physical psychological test card printed on coarse, fibrous unbleached handmade paper, complete with visible paper fiber, minor surface wear, and a rough, irregular raw cardboard margin around the central motif. The card fills the frame. The art style is raw expressionistic Art Brut, inspired by image_4.png and image_5.png. The graphic completely fills the entire card, which is the entire image. The entire image should look like a genuine analog artifact. The artwork features VERY thick, shaky, erratic, imperfect, hand-painted or linocut-style black contour lines, rendered with significant pressure variations and ink bleed, without any precise geometric shapes. The colors are deeply saturated but strictly matte and earthy (crimson red, golden yellow, forest green, deep blue), with uneven density and imperfect, bleeding fills showing the underlying paper texture. The composition is a naive, symbolical representation of dynamic inner conflict and striving. For example, a stylized, nach oben strebende, naive human figure (Will) represented by a red core is surrounded by an organized, yet hand-painted, arrangement of earthy green and yellow forms (surrounding clarity and structure). Above, a stylized golden yellow radiant form (Insight/Aspiration) is clearly separated but still hand-painted. Absolutely no text is visible. The lighting is directional, emphasizing the physical texture of the paper and ink. Strictly flat 2D artwork, no gradients, no 3D elements, no digital gloss. Aspect Ratio: 2:3"
    }`; 
